...
func TestCollectEnvVarNames(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			vagrantEnv:   nil,
			want:         []string{"ANTHROPIC_API_KEY", "CLAUDE_CODE_OAUTH_TOKEN", "DEBUG"},
		},
		{
			name:         "vagrant env only",
			enabledNames: []string{},
			vagrantEnv:   map[string]string{"CUSTOM_VAR": "value"},
			want:         []string{"ANTHROPIC_API_KEY", "CLAUDE_CODE_OAUTH_TOKEN", "CUSTOM_VAR"},
		},
		{
			name:         "merged MCP and vagrant env",
			enabledNames: []string{"memory", "filesystem"},
			vagrantEnv:   map[string]string{"CUSTOM_VAR": "value"},
			want:         []string{"ANTHROPIC_API_KEY", "CLAUDE_CODE_OAUTH_TOKEN", "CUSTOM_VAR", "DEBUG", "MAX_SIZE"},
		},
		{
		...
		},
		{
			...
			vagrantEnv:   nil,
			want:         []string{"ANTHROPIC_API_KEY", "CLAUDE_CODE_OAUTH_TOKEN", "PYTHON_ENV"},
		},
	}
